          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Wallet Search</h4>
                    <hr>
                     <form class="forms-sample" action="wllet_card_print.php" method="post" autocomplete="off">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Wallet ID</label>
