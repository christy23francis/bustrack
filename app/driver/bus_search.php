          ...
          <div class="content-wrapper">
            ...
            <!-- Start -->
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Search Bus No</h4>
                    <hr>
                    <form class="forms-sample" action="bus_search_no.php" autocomplete="off" method="get">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Bus No</label>
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <hr>
                    <form class="forms-sample" action="bus_search_name.php" autocomplete="off" method="get">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Bus Name</label>
                       <input list="bname" required class="form-control" name="bname" placeholder="Vehicle No">
                            <datalist id="bname">
                                <option value="">Select</option> 
                                 <?php
