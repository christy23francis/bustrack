<?php
	...
	$name=$_POST["name"];
	$result = $db->prepare("select * from conductor where name='$name'");
	$result->execute();
                      ...
                      <div class="col-lg-4">
                        ...
                        <div class="py-4">
                         <p class="clearfix">
                          ...
                          <br>
                          <form method="get" action="action/conductor_assign.php" autocomplete="off">
                            <div class="form-group">
                              ...
                              <input type="submit" value="Allow" class="btn btn-danger">
                              <a href="action/conductor_block.php?DLog_Id=<?php echo $DLog_Id;?>" class="btn btn-warning">Block</a>
                          </form>
