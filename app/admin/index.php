<?php
	...
	$waltot=0;	
	$resultw = $db->prepare("select * from  deposit");
	$resultw->execute();
	...
	$bustot=0;	
	$resultbus = $db->prepare("select * from  payment where status='Accept'");
	$resultbus->execute();
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0">Welcome Back ! Get updated with your recent updates !</span>
              </h3>
            </div>
            <div class="row">
                    ...
                    <div class="card bg-warning">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          ...
                          <i class="card-icon-indicator mdi mdi-wallet bg-inverse-icon-warning"></i>
                        </div>
                    ...
                    <div class="card bg-danger">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          ...
                          <i class="card-icon-indicator mdi mdi-coin-outline bg-inverse-icon-danger"></i>
                        </div>
                        <h6 class="text-white"> Since last month</h6>
                      </div>
                    </div>
                            ...
                            <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                              <div>
                                ...
                                <?php
									$tdc=0;	
									$dat=date("Y-m-d");
									$resultbus = $db->prepare("select * from  payment where date='$dat'");
									$resultbus->execute();
									for($i=1; $rowsbus = $resultbus->fetch(); $i++)
									{
										$tdc=$tdc+$rowsbus["amt"];
                            ...
                            <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                              <div>
                                ...
                                <?php
									$tdc=0;	
									$dat=date("Y-m-d");
									$resultbus = $db->prepare("select * from  deposit where date='$dat'");
									$resultbus->execute();
									for($i=1; $rowsbus = $resultbus->fetch(); $i++)
									{
										$tdc=$tdc+$rowsbus["amt"];
                  ...
                  <div class="card-body px-0 overflow-auto">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <?php							
						$tot=0;	
						$result = $db->prepare("select * from  payment where status='Pending'");
						$result->execute();
            ...
            <div class="row">
              ...
              <div class="col-xl-4 col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title text-black">Recent People</h4>
                    <p class="text-muted">All contacts</p>
                    
                    <?php							
						$result = $db->prepare("select * from  passenger limit 4");
						$result->execute();
						for($i=1; $rows = $result->fetch(); $i++)
						{
						?>
                      ...
                      <div class="col-12 col-sm-7">
                        <div class="row">
                          <div class="col-4 col-md-4">
                            <img class="customer-img" src="../photos/<?php echo $rows["photo"]?>" alt="" />
                          </div>
                          <div class="col-8 col-md-8 p-sm-0">
                            <h6 class="mb-0"><?php echo $rows["name"]?></h6>
                            <p class="text-muted font-12"><?php echo $rows["sex"]?></p>
                          </div>
                        </div>
                      </div>                     
                    </div>
              ...
              <div class="col-xl-4 col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title text-black">Recent Conductor</h4>
                    <p class="text-muted">All contacts</p>
                    <?php							
						$result = $db->prepare("select * from  conductor limit 2");
						$result->execute();
						for($i=1; $rows = $result->fetch(); $i++)
						{
						?>
              ...
              <div class="col-xl-4 col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title text-black">Recent Drivers</h4>
                    <p class="text-muted">All contacts</p>
						<?php							
                            $result = $db->prepare("select * from  driver limit 2");
                            $result->execute();
                            for($i=1; $rows = $result->fetch(); $i++)
                            {
                            ?>
