...
<div class="osahan-listing">
    ...
    <div class="row">
    	<?php		
		$result = $db->prepare("select distinct bname,vno,photo,Log_Id from vehicle where bname='$bname'");
		$result->execute();
		for($i=0; $rows = $result->fetch(); $i++)
		{
		?>	
        <div class="col-md-4">
            <a href="bus-details.php<?php echo '?bname='.$bname; ?>">
                <div class="card">
                    <div class="card-header">
                        BUS : <?php echo $rows["bname"];?> <br>
                        BUS ID : <?php echo $rows["Log_Id"];?>
                    </div>
                    <div class="card-body">
