...
<div class="osahan-signup">
    ...
    <div class="p-3">
        <form action="action/passenger_reg.php" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input type="test" class="form-control" name="age" min="15" max="100" required>
        </div>
        <div class="form-group">
