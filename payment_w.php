...
<div class="osahan-listing">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
            <hr>
                <form action="action/payment_upi.php" method="post" enctype="multipart/form-data" autocomplete="off">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" style="padding: 10px;">
                                ...
                                <datalist id="frm">
                                 ...
                                 <input list="retrun" required class="form-control" name="retrun" placeholder="Stop" id="fare">
                                <datalist id="retrun">
                                    <option value="">Select</option> 
                                     <?php
                                        $result = $db->prepare("select distinct(stop) from stops");
                                        ...
                                        for($i=0; $rows = $result->fetch(); $i++)
                                        {
                                        echo '<option>'.$rows['retrun'].'</option>';
                                        }
                                    ?>	                                         					
                                </datalist>
